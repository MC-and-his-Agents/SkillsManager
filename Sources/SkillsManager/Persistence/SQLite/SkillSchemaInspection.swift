...
nonisolated enum SkillSchemaInspection {
    ...
    static func expectedV6SchemaFingerprint() throws -> Data {
        try expectedSchemaFingerprint(
    ...
    static func expectedV7SchemaFingerprint() throws -> Data {
        try expectedSchemaFingerprint(
    ...
    static func expectedV8SchemaFingerprint() throws -> Data {
        try expectedSchemaFingerprint(
    ...
    static func expectedV10SchemaFingerprint() throws -> Data {
        try expectedSchemaFingerprint(
    ...
    static func expectedV12SchemaFingerprint() throws -> Data {
        try expectedSchemaFingerprint(
            ...
            statements: SkillSchemaV1.statements
                ...
                + SkillSchemaV10.statements
                + SkillSchemaV11.statements
                + SkillSchemaV12.statements
                + [SkillSchemaV9.expectedSkillsTableSQL],
            version: 12
        )
    }

    static func expectedV13SchemaFingerprint() throws -> Data {
        try expectedSchemaFingerprint(
            ...
            statements: SkillSchemaV1.statements
                ...
                + SkillSchemaV11.statements
                + SkillSchemaV12.statements
                + SkillSchemaV13.statements
                + [SkillSchemaV9.expectedSkillsTableSQL],
            version: 13
        )
    }

    static func expectedV14SchemaFingerprint() throws -> Data {
        try expectedSchemaFingerprint(
            ...
            statements: SkillSchemaV1.statements
                ...
                + SkillSchemaV12.statements
                + SkillSchemaV13.statements
                + SkillSchemaV14.statements
                + [SkillSchemaV9.expectedSkillsTableSQL],
            version: SkillSchemaV14.version
        )
    }

    static func expectedV15SchemaFingerprint() throws -> Data {
        try expectedSchemaFingerprint(
            objectNames: SkillSchemaV15.fingerprintedObjectNames,
            statements: SkillSchemaV1.statements
                + SkillSchemaV2.statements + SkillSchemaV3.statements
                + SkillSchemaV4.statements + SkillSchemaV5.statements
                + SkillSchemaV6.statements + SkillSchemaV7.statements
                + SkillSchemaV8.statements + SkillSchemaV9.statements
                + SkillSchemaV10.statements + SkillSchemaV11.statements
                + SkillSchemaV12.statements + SkillSchemaV13.statements
                + SkillSchemaV14.statements + SkillSchemaV15.statements
                + [SkillSchemaV9.expectedSkillsTableSQL],
            version: SkillSchemaV15.version
        )
    }

    static func expectedV16SchemaFingerprint() throws -> Data {
        try expectedSchemaFingerprint(
            ...
            statements: SkillSchemaV1.statements
                ...
                + SkillSchemaV12.statements + SkillSchemaV13.statements
                + SkillSchemaV14.statements + SkillSchemaV15.statements
                + SkillSchemaV16.statements
                + [SkillSchemaV9.expectedSkillsTableSQL],
            version: SkillSchemaV16.version
        )
    }
