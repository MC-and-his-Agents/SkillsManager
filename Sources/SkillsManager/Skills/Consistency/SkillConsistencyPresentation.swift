...
func localizedLibraryDiagnosticCode(_ code: LibraryDiagnosticCode) -> String {
    switch code {
    case .databaseMissing: String(localized: "Database missing", bundle: SkillsManagerLocalizationResources.bundle)
    case .ssotMissing: String(localized: "Managed library missing", bundle: SkillsManagerLocalizationResources.bundle)
    case .schemaMismatch: String(localized: "Database schema mismatch", bundle: SkillsManagerLocalizationResources.bundle)
    case .legacyMigrationBlocked: String(localized: "Legacy migration blocked", bundle: SkillsManagerLocalizationResources.bundle)
    case .journalNeedsRepair: String(localized: "Journal needs repair", bundle: SkillsManagerLocalizationResources.bundle)
    case .orphanSSOTDirectory: String(localized: "Orphan managed directory", bundle: SkillsManagerLocalizationResources.bundle)
    case .unknownSSOTEntry: String(localized: "Unknown managed entry", bundle: SkillsManagerLocalizationResources.bundle)
    case .databaseSkillMissingDirectory: String(localized: "Managed Skill directory missing", bundle: SkillsManagerLocalizationResources.bundle)
    case .contentFingerprintDrift: String(localized: "Content fingerprint drift", bundle: SkillsManagerLocalizationResources.bundle)
    case .rootIdentityChanged: String(localized: "Managed root identity changed", bundle: SkillsManagerLocalizationResources.bundle)
    case .permissionDenied: String(localized: "Permission denied", bundle: SkillsManagerLocalizationResources.bundle)
    case .databaseBusy: String(localized: "Database busy", bundle: SkillsManagerLocalizationResources.bundle)
    case .cleanupDebt: String(localized: "Cleanup pending", bundle: SkillsManagerLocalizationResources.bundle)
    case .legacyArchiveChanged: String(localized: "Legacy archive changed", bundle: SkillsManagerLocalizationResources.bundle)
    case .unrecoverable: String(localized: "Unrecoverable library error", bundle: SkillsManagerLocalizationResources.bundle)
    }
}
...
func localizedRecommendedActionCode(_ code: String) -> String {
    switch code {
    case "restoreDatabase": String(localized: "Restore database", bundle: SkillsManagerLocalizationResources.bundle)
    case "restoreSSOT": String(localized: "Restore managed library", bundle: SkillsManagerLocalizationResources.bundle)
    case "upgradeApplication": String(localized: "Update Skills Manager", bundle: SkillsManagerLocalizationResources.bundle)
    case "retryLegacyMigration": String(localized: "Retry legacy migration", bundle: SkillsManagerLocalizationResources.bundle)
    case "repairJournal": String(localized: "Repair journal", bundle: SkillsManagerLocalizationResources.bundle)
    case "inspectOrphan": String(localized: "Inspect orphan directory", bundle: SkillsManagerLocalizationResources.bundle)
    case "inspectUnknownEntry": String(localized: "Inspect unknown entry", bundle: SkillsManagerLocalizationResources.bundle)
    case "restoreSkillDirectory": String(localized: "Restore Skill directory", bundle: SkillsManagerLocalizationResources.bundle)
    case "resolveContentDrift": String(localized: "Resolve content drift", bundle: SkillsManagerLocalizationResources.bundle)
    case "restartAfterRootRepair": String(localized: "Repair root and restart", bundle: SkillsManagerLocalizationResources.bundle)
    case "fixPermissions": String(localized: "Fix permissions", bundle: SkillsManagerLocalizationResources.bundle)
    case "retryLater": String(localized: "Retry later", bundle: SkillsManagerLocalizationResources.bundle)
    case "retryCleanup": String(localized: "Retry cleanup", bundle: SkillsManagerLocalizationResources.bundle)
    case "inspectLegacyArchive": String(localized: "Inspect legacy archive", bundle: SkillsManagerLocalizationResources.bundle)
    case "manualRecovery": String(localized: "Recover library manually", bundle: SkillsManagerLocalizationResources.bundle)
    default: code
    }
}
