...
struct SkillDatabaseSchemaTests {
    ...
    func createsAndReopensCurrentSchema() throws {
        ...
        do {
            ...
            #expect(try connection.querySingleInt("PRAGMA user_version") == 7)
            #expect(try connection.userTableNames() == SkillSchemaV7.tableNames)
            ...
            #expect(strictCount == 10)
        }

        let reopened = try SkillSchemaMigrator.open(at: location.database)
        #expect(try reopened.querySingleInt("PRAGMA user_version") == 7)
    ...
    func handlesAConcurrentV0Migration() throws {
        ...
        #expect(try first.querySingleInt("PRAGMA user_version") == 7)
        #expect(try second.querySingleInt("PRAGMA user_version") == 7)
        #expect(try second.userTableNames() == SkillSchemaV7.tableNames)
    }
    ...
    func rejectsInvalidSchemaStates() throws {
        ...
        try futureConnection.execute("PRAGMA user_version = 8")
        #expect(throws: SQLiteStoreError.self) {
