...
struct SkillDatabaseSchemaTests {
    ...
    func createsAndReopensCurrentSchema() throws {
        ...
        #expect(try reopened.querySingleInt("PRAGMA user_version") == 11)
    ...
    func handlesAConcurrentV0Migration() throws {
        ...
        #expect(try first.querySingleInt("PRAGMA user_version") == 11)
        #expect(try second.querySingleInt("PRAGMA user_version") == 11)
        #expect(try second.userTableNames() == SkillSchemaV11.tableNames)
    }
    ...
    func rejectsInvalidSchemaStates() throws {
        ...
        try futureConnection.execute(
            "PRAGMA user_version = \(SkillSchemaV11.version + 1)"
        )
        #expect(throws: SQLiteStoreError.self) {
