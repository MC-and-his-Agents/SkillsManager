...
struct SkillDatabaseSchemaTests {
    ...
    func createsAndReopensCurrentSchema() throws {
        ...
        do {
            ...
            #expect(try connection.userTableNames() == SkillSchemaV16.tableNames)
            ...
            #expect(strictCount == Int64(SkillSchemaV16.tableNames.count))
        }

        let reopened = try SkillSchemaMigrator.open(at: location.database)
        #expect(try reopened.querySingleInt("PRAGMA user_version") == 16)
    ...
    func handlesAConcurrentV0Migration() throws {
        ...
        #expect(try first.querySingleInt("PRAGMA user_version") == 16)
        #expect(try second.querySingleInt("PRAGMA user_version") == 16)
        #expect(try second.userTableNames() == SkillSchemaV16.tableNames)
    }
    ...
    func rejectsInvalidSchemaStates() throws {
        ...
        try futureConnection.execute(
            "PRAGMA user_version = \(SkillSchemaV16.version + 1)"
        )
        #expect(throws: SQLiteStoreError.self) {
