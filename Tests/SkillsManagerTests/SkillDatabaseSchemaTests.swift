...
struct SkillDatabaseSchemaTests {
    ...
    func createsAndReopensCurrentSchema() throws {
        ...
        do {
            ...
            #expect(try connection.userTableNames() == SkillSchemaV13.tableNames)
            ...
            #expect(strictCount == Int64(SkillSchemaV13.tableNames.count))
        }

        let reopened = try SkillSchemaMigrator.open(at: location.database)
        #expect(try reopened.querySingleInt("PRAGMA user_version") == 13)
    ...
    func handlesAConcurrentV0Migration() throws {
        ...
        #expect(try first.querySingleInt("PRAGMA user_version") == 13)
        #expect(try second.querySingleInt("PRAGMA user_version") == 13)
        #expect(try second.userTableNames() == SkillSchemaV13.tableNames)
    }
    ...
    func rejectsInvalidSchemaStates() throws {
        ...
        try futureConnection.execute(
            "PRAGMA user_version = \(SkillSchemaV13.version + 1)"
        )
        #expect(throws: SQLiteStoreError.self) {
